<template>
    ...
    <div>Мразите формите ? изпратете ни 
      <span class="underline"><a href="mailto:staskata1998@gmail.com">имейл</a></span> вместо това.
    </div>
    <div class="grid_two">
      <div class="mt-20 svg_wrap">
      ...
      <div class="form_wrapper center">
        ...
        <div class="input_holder" :class="{'error' : errors.phone }">
          <div class="wrap_elements">
            <span class="material-icons">phone</span>
            <input type="text" name="phone" placeholder="Телефонен номер" v-model="form.phone">
          </div>
        ...
        <textarea name="message" id="message" v-model="form.message" class="textarea" placeholder="Въведете вашето съобщение"></textarea>
        <div class="mt-10">
      ...
      this.setForm();
		...
		methods: {
			submitForm() {
				...
				axios.post('/api/contact',this.form).then((res) => {
          this.resetForm();
